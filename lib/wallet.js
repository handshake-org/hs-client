...
class WalletClient extends Client {
  ...
  /**
   * Create a coin transfer transaction, fill, sign, and broadcast. Dollarydoos as value in outputs.
   * @param {Object} options
   * @param {Array} option.outputs
   * @param {String} options.passphrase
   * @param {Boolean} options.smart
   * @param {Number} options.depth
   * @param {String} options.account
   * @param {Number} options.rate
   * @param {String} options.outputs.address
   * @param {Amount} options.outputs.value
   * @returns {Promise}
   */
